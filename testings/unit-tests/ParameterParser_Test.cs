...
namespace Landis.Test.Output.Reclass
{
	[TestFixture]
	public class ParameterParser_Test
	{
		...
		[Test]
		[ExpectedException(typeof(LineReaderException))]
		public void Coefficients_Unknown()
		{
			TryParse("Coefficients-Unknown.txt", 12);
		}
		...
		[Test]
		[ExpectedException(typeof(LineReaderException))]
		public void Coefficients_Repeated()
		{
			TryParse("Coefficients-Repeated.txt", 14);
		}
		...
		[Test]
		[ExpectedException(typeof(LineReaderException))]
		public void Coefficients_Missing()
		{
			TryParse("Coefficients-Missing.txt", 12);
		}
		...
		[Test]
		[ExpectedException(typeof(LineReaderException))]
		public void Coefficients_BadNumber()
		{
			TryParse("Coefficients-BadNumber.txt", 12);
		}
		...
		[Test]
		[ExpectedException(typeof(LineReaderException))]
		public void Coefficients_Extra()
		{
			TryParse("Coefficients-Extra.txt", 12);
		}
